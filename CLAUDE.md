...
Decisions DD-1 through DD-14 are settled. Do not re-open them without a concrete reason
...
GitHub Actions job (DD-13), and phase 3's public, static status page (DD-14: generated
files on GitHub Pages, no server). Neither is a licence for more.
